  ...
  return (
    <section className="info-panel-section">
      ...
      <p className="hug-copy">
        ChampMaps is 100% client-side and open-source. Help us build the future
          ...
          <div className="hug-row-content">
            {repoUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Open ChampMaps repository on GitHub"
              >
            ...
            {repoUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Star ChampMaps on GitHub"
              >
            ...
            {kofiUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Support ChampMaps on Ko-fi"
              >
            ...
            {socialLinks.map(({ href, Icon, label }) =>
              href ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label={`Follow ChampMaps on ${label}`}
                  title={label}
                >
